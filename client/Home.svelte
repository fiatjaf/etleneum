...
<main>
  ...
  <h2>
    Etleneum is a global, open-source platform for <del>de</del><ins>the</ins> centralized
    applications.
  </h2>
  <p>
  ...
  <article>
    ...
    <p>
      ...
      <b>resolve</b> and settled the bet. Account <i>12</i> ended up with all the
      satoshis.
    </p>
    <p>
      ...
      a certain way and can also <i>transfer funds</i> from the contract to an account.
    </p>
  </article>

  <p>
    <a href="#/docs">Read the docs</a
    >{#if window.location.host === 'etleneum.com'}&nbsp;and start creating some <em
        >free</em
      >
      contracts at the
  ...
  {#if window.location.host === 'etleneum.com'}
    <p>
      If you need help, have questions about Etleneum or any of the contracts,
      go talk to us at
